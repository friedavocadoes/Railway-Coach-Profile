...
<nav class="bg-blue-900/30 backdrop-blur-md border-b border-white/20 fixed w-full z-50">
                    ...
                    <ul class="absolute hidden w-40 group-hover:block bg-white shadow-lg rounded-lg mt">
                        ...
                        <li>
                            <form action="{{ route('logout') }}" method="POST" class="block">
                                @csrf
                                <button type="submit"
                                    class="cursor-pointer w-full text-left px-4 py-2 hover:bg-gray-100 hover:text-red-800">Logout</button>
                            </form>
                        </li>
                    </ul>
                </li>
